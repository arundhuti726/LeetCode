...
# MAGIC %md
# MAGIC ### Run Time: </h3> 557 ms
# MAGIC <h3> Beats: </h3> 38%
...
def largest_orders(orders: pd.DataFrame) -> pd.DataFrame:
    ...
    orders['count'] = orders.groupby('customer_number').cumcount() + 1  #running total
    orders = orders.where(orders['count']==orders['count'].max()).dropna()
